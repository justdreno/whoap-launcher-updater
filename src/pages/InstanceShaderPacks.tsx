...
interface InstanceShaderPacksProps {
    instanceId: string;
    onBack: () => void;
...
export const InstanceShaderPacks: React.FC<InstanceShaderPacksProps> = ({ instanceId, onBack, hideBackButton, hideHeader }) => {
    ...
    const handleAddItems = async () => {
        try {
            ...
            if (res.success) {
                showToast(`Shader packs added`, "success");
                loadInstalledItems();
            } else if (res.error) {
        ...
        <div className={styles.container}>
            ...
            <div className={styles.searchArea}>
                <input
                    ...
                    placeholder={`Filter installed shaders...`}
                ...
                <div className={styles.actionButtons}>
                    ...
                    <button className={`${styles.addModBtn} ${styles.secondaryAdd}`} onClick={handleAddItems} title="Add Local Shader">
                        <Plus size={20} />
                        <span>Local</span>
                    </button>
                </div>
            ...
            <div className={styles.content}>
                {loading ? (
                    ...
                    <div className={styles.modList}>
                        {installedItems.length === 0 && <div style={{ color: '#888', padding: 20 }}>No shaders installed.</div>}
